 ...
 */
public class ChangePasswordActivity extends BaseActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "foo@example.com:hello", "@:1","kiki@qq.com:12345"
    };
    /**
    ...
    private void attemptLogin() {
        ...
        if (!password.equals(password2)) {
            mPasswordView2.setError(getString(R.string.error_not_matching_password));
...
*/
            ...
            SpUtil.getInstance().putString(AppConstants.LOCK_USER,mEmail);
            SpUtil.getInstance().putString(AppConstants.LOCK_PWD,mPassword);
